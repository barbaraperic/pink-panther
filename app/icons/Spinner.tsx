export default function SpinnerIcon(props: any) {
    return (
        ...
        >
            <defs>
                <linearGradient
                    gradientTransform="matrix(39.9996 0 0 39.9996 372.334 209.79)"
                    ...
                    y2="0"
                >
                    <stop offset="0" stopColor="#f259bd" />
                    <stop offset="1" stopColor="#780a5f" />
                </linearGradient>
            </defs>
